...
public class ACS_Certificate__c  extends com.sforce.soap.enterprise.sobject.SObject  implements java.io.Serializable {
    ...
    private java.lang.String support_Status__c;
    ...
    public ACS_Certificate__c(
           ...
           java.lang.String support_Status__c) {
        super(
            fieldsToNull,
            id);
        ...
        this.name = name;
        this.support_Status__c = support_Status__c;
    }
    ...
    /**
     * Gets the support_Status__c value for this ACS_Certificate__c.
     * 
     * @return support_Status__c
     */
    public java.lang.String getSupport_Status__c() {
        return support_Status__c;
    }


    /**
     * Sets the support_Status__c value for this ACS_Certificate__c.
     * 
     * @param support_Status__c
     */
    public void setSupport_Status__c(java.lang.String support_Status__c) {
        this.support_Status__c = support_Status__c;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.support_Status__c==null && other.getSupport_Status__c()==null) || 
             (this.support_Status__c!=null &&
              this.support_Status__c.equals(other.getSupport_Status__c())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getSupport_Status__c() != null) {
            _hashCode += getSupport_Status__c().hashCode();
        }
    ...
    static {
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("support_Status__c");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sobject.enterprise.soap.sforce.com", "Support_Status__c"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
